    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center z-50 text-white font-sans p-6 bg-black/30 backdrop-blur-sm transition-all duration-1000">
      <div className="max-w-md w-full bg-slate-900/90 p-8 rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-xl relative overflow-hidden animate-fade-in">
        ...
        <div className="relative z-10">
            ...
            className="w-full py-4 bg-[#00b14f] hover:bg-[#009241] text-white font-black rounded-xl shadow-lg shadow-green-900/20 transform transition-all hover:scale-[1.02] active:scale-[0.98] text-lg tracking-wide uppercase italic"
            >
            ...
            <div className="mt-8 flex flex-col items-center gap-2">
                <div className="flex items-center gap-2 text-[10px] text-slate-500 uppercase font-black tracking-widest">
                    ...
                    <span className="text-green-500">Grab Maps API</span>
                    <span className="text-slate-700">•</span>
                    <span className="text-cyan-400">Gemini 2.0</span>
                </div>
                <a 
                    href="https://grab.com" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="inline-flex items-center gap-2 text-xs text-slate-500 hover:text-[#00b14f] transition-colors font-mono group"
                >
                    <span>Powered by</span>
                    <span className="font-bold group-hover:underline decoration-green-500/50 underline-offset-2">GRAB</span>
                </a>
            </div>
        </div>
      </div>
